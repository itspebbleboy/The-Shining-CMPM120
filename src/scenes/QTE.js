class QTE extends Phaser.Scene {
  ...
  create() {
    ...
    this.anims.load('gameoverScreen', 'shining_atlas', './assets/shining.json');
    this.anims.create({
      key: 'gameoverScreen',
      ...
      frameRate: this.calculateFrameRate(5, this.qteTimerDuration),  // Calculate frame rate based on 5 frames and 1000 milliseconds duration
      //repeat: -1
    });
